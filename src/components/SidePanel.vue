...
<template>
	<TransitionRoot as="template" :show="isOpen">
		<Dialog as="div" class="z-40" @close="isOpen = false">
			<TransitionChild as="template" enter="ease-in-out duration-300" enter-from="opacity-0" enter-to="opacity-100"
				...
				<div class="absolute inset-0 bg-base-100/50 transition-opacity" />
			</TransitionChild>
				...
				<div class="pointer-events-none absolute inset-y-0 right-0 flex max-w-full">
					<TransitionChild as="template" enter="transform transition ease-in-out duration-500"
						...
						<DialogPanel class="pointer-events-auto relative w-screen md:max-w-xl">
							<div class="flex h-full flex-col overflow-y-auto bg-base-100 p-4 shadow-xl">
